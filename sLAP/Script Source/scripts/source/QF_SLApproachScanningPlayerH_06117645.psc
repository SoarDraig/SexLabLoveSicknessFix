...
;BEGIN ALIAS PROPERTY PlayerHouseInteriorStrollB
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_PlayerHouseInteriorStrollB Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY PlayerHouseExteriorStrollB
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_PlayerHouseExteriorStrollB Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY PlayerHouseExteriorStrollA
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_PlayerHouseExteriorStrollA Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY PlayerHouseInteriorStrollA
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_PlayerHouseInteriorStrollA Auto
;END ALIAS PROPERTY
...
(Alias_PlayerHouseCenterMarkerActivater.getreference()).moveto(Alias_BackXmarker.getreference())
(Alias_PlayerHouseTalkingActivater.getreference()).moveto(Alias_BackXmarker.getreference())
(Alias_VisitorRef.getreference() as actor).moveto(SLAPPTemporaryVisitorBackMarker)
;END CODE
EndFunction
;END FRAGMENT

...
CurrentValue_mkd += 21 + Utility.RandomFloat(1,7)
...
CurrentValue_md += 14 + Utility.RandomFloat(1,3)
...
upkeep.drugged(CurrentValue_mkd, slsw_tam_stage1, slsw_tam_stage2, slsw_tam_stage3, slsw_tam_stage4)

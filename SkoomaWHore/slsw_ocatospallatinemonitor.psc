...
CurrentValue_pd += 17 + Utility.RandomFloat(1,5)
...
CurrentValue_md += 15 + Utility.RandomFloat(1,5)
...
CurrentValue_mkd += 15 + Utility.RandomFloat(1,5)
...
upkeep.drugged(CurrentValue_pd, slsw_op_stage1, slsw_op_stage2, slsw_op_stage3, slsw_op_stage4)

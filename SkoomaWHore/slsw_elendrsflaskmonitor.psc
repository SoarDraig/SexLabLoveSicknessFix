...
CurrentValue_pd += 22 + Utility.RandomFloat(1,5)
...
CurrentValue_md += 18 + Utility.RandomFloat(1,5)
...
CurrentValue_mkd += 20 + Utility.RandomFloat(1,5)
...
upkeep.drugged(CurrentValue_pd, slsw_ef_stage1, slsw_ef_stage2, slsw_ef_stage3, slsw_ef_stage4)

...
CurrentValue_md += 17 + Utility.RandomFloat(1,5)
...
CurrentValue_mkd += 18 + Utility.RandomFloat(1,5)
...
upkeep.drugged(CurrentValue_pd, slsw_tc_stage1, slsw_tc_stage2, slsw_tc_stage3, slsw_tc_stage4)

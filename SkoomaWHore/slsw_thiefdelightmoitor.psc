...
CurrentValue_md += 9 + Utility.RandomFloat(1,6)
...
CurrentValue_mkd += 11 + Utility.RandomFloat(1,6)
...
upkeep.drugged(CurrentValue_pd, slsw_td_stage1, slsw_td_stage2, slsw_td_stage3, slsw_td_stage4)

...
CurrentValue_pd += 19 + Utility.RandomFloat(1,11)
...
CurrentValue_md += 12 + Utility.RandomFloat(1,11)
...
CurrentValue_mkd += 19 + Utility.RandomFloat(1,11)
...
upkeep.drugged(CurrentValue_pd, slsw_tf_stage1, slsw_tf_stage2, slsw_tf_stage3, slsw_tf_stage4)
